...
- 🗓️ 2025.09.13 🗓️ 前几天刚通知说近期已经很少有入口被通报了，于是就把置顶长达两个月的通报事件的通知移至“大事留档”。然而好景不长，最近通报又多了起来，也是被狠狠打脸了。既然防火墙大哥的脾气如此阴晴不定，那我们只能**常态化看待通报**了。但我依然觉得不用过度担忧，总有应对方法的，比如未来可能会有越来越多的机场使用“阅后即焚”模式（在正文的“机场列表”上方有介绍）。此通知将长期保留。🗓️ 2025.09.28 🗓️ **有些机场虽然未采用阅后即焚模式**，**但是在受到通报后**，**机场主是有可能会重置所有用户的订阅链接的**。**因此**，**如果你发现所有节点都不可用**，**且订阅无法更新**，**请重新到官网导入订阅**。🗓️ 2025.11.04 🗓️ 随着通报的常态化，市面上有少部分机场已经采取了比“阅后即焚”更为极端的防护措施，那就是“取消订阅链接，只允许使用机场官方客户端”，即类似于传统 VPN 软件那样的登录后“一键连”的方式。本文的机场目前暂无采用该方式，但也建议做好相应心理准备。🗓️ 2025.12.06 🗓️ 从上个月底开始，在通报频繁的当下，又不断有机场的节点域名被污染，这个基本也算是常态化了（将代理软件的本地 DNS 设置为 `223.5.5.5` 或 `119.29.29.29` 等公共 DNS 能一定程度防止污染。如果代理软件不支持修改 DNS，那就直接改相应设备的 DNS。如果不知道怎么修改 DNS，请自行搜索 `代理软件 or 操作系统 or 手机品牌 + 怎么修改 DNS`）。入口通报只会影响到中转和专线，DNS 污染则连直连也会受影响。虽然依然不至于多恐慌，但可以看见的是，现在各机场的稳定性都是大不如前的，包括一线机场。总之，现在翻墙的 Debuff 越来越多，机场主的运营压力也是越来越大，压力大就容易撂挑子不干。因此，真心强烈建议不要年付！🗓️ 2026.03.29 🗓️ 现在中转机场的处境是越来越差了，除去通报和攻击，本月中旬又流传着一份“电信拔线文件”，该文件的大致内容就是上头要求整改用于翻墙的服务，可谓是雪上加霜。虽然该文件并没有“官方来源”，但是近期大量机场的电信入口确实都覆灭了。所以，该文件也许是假的，但它的内容基本是真的（顺带一提，联通似乎也开始有动作了）。为了避免制造恐慌，本来我是不想提这件事情的，但最终还是忍不住想说点个人看法（其实我对这件事情的态度跟“通报事件”是差不多的）：①  首先，给中转机场们“洗个地”：最近体验变差，不是机场主抠门不舍得花钱用好线路，而是资源稀缺，心有余而力不足。作为用户，近期只需躺平就好了，不要试图通过购买多家中转机场来解决问题，这样只会浪费精力与金钱，无济于事。② 焦虑很正常，但没必要过于焦虑。路被封死的概率约等于彩票中大奖的概率，如果害怕失联，就多备一两个直连机场。最最差的情况就是回到大直连时代，然而我认为这种情况的概率也是很低的。③ 喂完鸡汤，该打的针还是得打：短时间内翻墙体验变差难以避免。至于未来，我也不盲目乐观给你们画饼，但想回到前几年的“中转盛世”肯定是不可能的，那种好日子在 DDOS 猖獗以及通报常态化后就已经消失了。虽然由奢入俭难，但你我还是得慢慢适应现在的环境。④ 百年不变四字真经：不要年付！不要年付！不要年付！
- 🗓️ 2026.04.02 🗓️ 如上方通知所说，拔线文件可能是假的，但内容确实是真的。这两天机场圈相当动荡，大部分中转机场受此影响，体验大幅度下滑，节点大面积不可用也是屡见不鲜。因此，**至少未来一个月内**，**都强烈不建议购买或续费中转机场**，**只建议购买直连机场**。此通知暂不删除（在此通知存在期间，中转机场如有不稳定的情况，我不会为其添加 🟨 标识或通知，当前情况，默认全都如此。除非有跑路迹象，或是改为强制使用客户端等特殊情况，才会专门通知）。🗓️ 2026.04.09 🗓️ 部分中转机场近期已新增了直连节点以作应对，之后“拔线”如果力度加大或是持续时间较长，也许会有很多中转机场不得不转型为直连机场。但即使如此，在当前时期，我暂不会把他们的类型从“中转”改为“直连”。因为这个阶段我只推荐直连机场，而这些半路转型的，我不认为他们短期内能做得比原先就是搞直连的做得更好。
- 🗓️ 2026.04.17 🗓️ 自即日起，不再对使用了 `Vless` 和 `Hysteria2` 协议的机场作标识。大致原因如下：① 这两个协议如今已算不上新协议，绝大部分主流代理软件都已支持，所以没必要专门标识。② 由于近期的“拔线事件”，不少中转机场上线了直连节点，甚至会用上 `AnyTLS` 这类更为新的协议，所以“旧标识”要为“新标识”让道（两者虽可共存，但前者确实没必要存在了）。详见机场列表上方的 `协议 2.0`。此通知将于 5.15 删除。
- 🗓️ 2026.04.22 🗓️ `壹速云` 的用户请注意，该机场近期会逐步将所有节点的协议更换为 `AnyTLS` 协议，请查当前所使用的代理软件是否支持该协议，如果不支持，建议尽快更新至支持该协议的版本或者更换为其他支持该协议的代理软件（可参考本文机场列表上方的 `协议 2.0`）。此通知将于 5.20 删除。🗓️ 2026.04.24 🗓️ 目前大部分节点都已更换完毕（注：需前往官网重新导入订阅。`Shadowrocket` 则直接更新订阅即可，如更新后无法看到 `AnyTLS` 协议的节点，说明所使用的 `Shadowrocket` 版本较低，请前往应用商店更新该软件）。
- 🗓️ 2026.04.24 🗓️ 在昨日，有小道消息称“中国联通、移动、电信运营商对海外方向均报告网络故障”，具体内容及来源此处就不提供了，因为内容较长且依旧为非官方消息。具体表现就是许多用户几乎无法使用直连节点（要么完全用不了，要么频繁频繁断流，要么速度接近 0），具体影响范围无法统计，有些地区完全无感，有些地区则出现了上述情况。截至目前可观察到的情况是：移动的数据流量最受影响，移动的宽带流量次之，电信与联通基本不受影响。不同协议的影响也不同，如 `IPv4` 和 `TCP` 流量受影响较大，`IPv6` 和 `UDP` 则影响较小。昨日没发通知是因为我本以为只是个普通的故障，但现在问题已超过 24 小时，或许并不是简单的故障。至于事情会怎么发展就没必要猜了，让子弹再飞一会吧，此通知暂不删除。🗓️ 2026.05.03 🗓️ 该事件近期并没有继续“恶化”，看起来算是恢复正常了。此通知将于 5.15 移至“大事留档”。
- 🗓️ 2026.04.28 🗓️ 机场圈赫赫有名的 [快连 VPN 已宣布停止中国大陆地区的业务运营](https://letsvpn.world/blog/c130bd)（虽名为 VPN，但本质跟机场没大区别，就像近期一些强制使用客户端的机场）。尽管它并不存在本文的推荐列表中，但我还是想哔哔几句，毕竟，它还是很有代表性的。所谓代表性并不是它多好，而是它的存活时间（2019 至今）和知名度（广告投放量极多）太夸张了。就这两者而言，它说第二，没人敢说第一。虽然它的性价比极低（插个题外话：作为本人接触的第二款付费 VPN，但凡它便宜些或不限制 2 个设备，也许本文就不会诞生，也许今日我也是众多难民之一），口碑也不怎么样，但是论“活”这件事情，基本不会有人质疑它，甚至很多传言认为其是有背景的钓鱼 VPN，才能存活这么久。然而即使“命硬”如快连，在这一年里的各种持续打压下（通报，攻击，拔线等），也终究挺不住。因此，我决定将此事件作为“**任何机场都会跑路的标准教材**”，不要以为“老牌”和“贵”就能经久不衰。**深情往往被辜负**，**任何翻墙服务都不值得你年付**。此通知将于 5.15 移至“大事留档”。🗓️ 2026.05.09 🗓️ 昨日，[快连表示恢复正常运营](https://letsvpn.world/blog/f20bkd)。然而实际表现是只有香港节点勉强能用，其余地区的节点基本都不可用（连都连不上那种）。并且，现在已没有微信或支付宝这两个国内常用的支付方式。该链接中也有提及“无法保证中国大陆地区的服务状态”，由此可看出它并没有打赢复活赛。因此，这并不能说明当前国内对梯子的打击力度减少了。
- 🗓️ 2026.05.02 🗓️ `农夫山泉` 的老用户请注意，该机场自从 2 月底被攻击后便改为强制客户端，之后在 4 月初又把机场卖给了新老板。如今，旧老板 [换皮](https://www.laocunzhang.net/#/register?code=jj7YELQj) 归来。在这个新机场注册的用户，只要使用的邮箱跟原先的 `农夫山泉` 所使用的邮箱相同，那么可以进入“个人中心”点击“订阅补偿”，即可“白嫖”一份跟农夫山泉一样的套餐（旧老板保留了 4.1 前的数据。周期套餐会得到 1 个月额外补偿）。此通知将于 5.20 删除。注：① 这两个机场现在没有任何关系，老板与节点的线路是不同的，该操作不影响原机场的套餐。另外，这个新机场的订阅机制是“真阅后即焚”，即本文机场列表上方的 🔥🔥 标识，也就是 `农夫山泉` 在强制客户端之前的机制。② **此通知主要起一个“福利”作用**，**不作购买建议**！在 4.1 前未注册过 `农夫山泉` 的用户，不建议购买该机场。毕竟，这种“换皮”的行为我还是有点反感的。虽然只是“卖后换皮”，不是“跑后换皮”。但话又说回来，鉴于旧老板所运营的机场在我推的这几年里表现都不错，以及新机场能让旧用户白嫖套餐，所以未来是可能会推这家机场的，但短期内不会，所以只把该机场的链接放于此处（最快也在 6 月中旬之后，毕竟现在机场圈并不太平，6 月初更是敏感时期，至少得能相对平稳渡过这个时期，才能上台面）。
...
👇 **机场购前须知**：
 ...
 - 🟨：**表示该机场当前存在某种问题**，**如节点质量明显下降或是大量节点不可用**（具体状况建议查看本文顶部的“重要通知”，提供该标识主要是防止有人没看通知），原因可能是被攻击，被通报，线路故障等。
   - 一般情况下，当问题修复之后，我会删除该标识，但如果迟迟没有恢复，我会考虑不再推荐相应机场。
   - 特殊情况下，即使问题修复了，我还会对其进行一定时间的观察（时间长短视情况而定），在观察结束前，不会删除该标识。
   - 总之，带有该标识的机场**暂不推荐购买**。
 - 🔥：表示该机场的**订阅链接**使用了“**阅后即焚**”模式：指在官网复制订阅链接后，该订阅链接在一定时间内（一般为 5 分钟）可导入代理软件。超过该时间后，如果想导入代理软件，需要重新复制订阅链接（注意，这个时间不一定是从你复制那一刻算起的，不同机场的实现方式会有一定差异。如果复制后导入失败，那可能是正巧失效了，此时可以尝试刷新网页，再重新复制订阅链接）。因此，**导入订阅后**，**请勿再更新订阅**（因为有些代理软件在更新订阅时会先清除当前订阅的节点，而由于这种订阅是阅后即焚的，就会导致更新后节点全部消失，需要重新前往官网获取），**如果设置了自动更新订阅**，**也请关闭**（虽然我在之前的通知里说近期要勤更新订阅，但是“阅后即焚”模式是相反的，导入后就别再更新）。所谓“阅后即焚”模式是在 2025 年 7 月的“入口通报事件”中，为了防止订阅泄漏以至于入口被通报，由某一线机场率先使用，因为有着不错的效果（注意：**有效果不代表可以完全避免被通报**），所以有一些机场也在跟进该模式。但该模式也是有缺点的，那就是当节点发生变化时，需要重新到官网获取订阅链接，比较麻烦（**想保证使用最新节点可每天获取一次订阅。但其实也没必要这样，节点变化一般不会很频繁，等到节点不可用或体验不佳时再重新订阅即可**）。以及无法通过更新订阅来查看自己当前剩余流量，只能前往官网查看。如果无法接受这些缺点，请避开带有 🔥 标识的机场。
    - 🔥🔥：更严格的“阅后即焚”，或者说真正意义上的“阅后即焚”。上述的“阅后即焚”在限制时间内是可以多次导入的，而更严格的“阅后即焚”即使是在限制时间内，也只能导入一次。也就是说，假如你现在在官网获取了一个订阅链接，当你将其导入到某代理软件后，该订阅链接就会立即失效，之后如果你想导入到另一个代理软件，你需要到官网再获取一次订阅链接才能导入。注意：**这种“真一次性”的订阅**，**不要发送到任何平台**。比如，你在电脑访问官网并获取了订阅链接，之后在微信中把该链接发送给自己，然后在手机中复制该链接，并将该链接导入到代理软件。这样做有概率会导入失败，因为微信可能会**扫描该链接**，导致该链接“**被使用过**”，从而失效。国外软件也可能有该问题，因为许多软件都有“**链接预览**”的功能，这同样会导致链接“**被使用过**”。不过，即使不是这种真一次性订阅，也尽可能别发送到微信等国内平台。
    - 🔥🔑：与上述“阅后即焚”的区别在于，它**使用自家机场的节点时**，**可随意更新订阅**。比如 A 机场带有该标识，那么在超过阅后即焚的时间限制后，如果不使用代理（未连接任何节点）或者使用的是 B 机场的节点，将无法再更新订阅，如需更新订阅，需重新前往 A 机场的官网获取订阅。而如果使用的是 A 机场的节点（当然，还有个前提，那就是所使用的节点是未超时的），那么绝大多数时候都可以更新订阅（**例外的情况是**：**机场主重置了所有人的订阅链接**），即相当于没有“阅后即焚”的限制。
 - 🔒：**表示该机场只能使用其提供的客户端**（客户端的下载方式通常在官网的“使用文档”中有说明），**不能使用订阅链接导入到代理工具**，就类似于传统的 `VPN` 软件。这种方式的好处是能够较有效防止通报与攻击，不过也有不少坏处，如：部分设备可能不支持（如软路由，iOS，Linux。不同机场支持情况不同，具体支持情况请前往官网查看。购买这类机场前务必查看该机场是否支持自己的设备），客户端安全性未知（如果担心客户端会泄露个人隐私或是携带病毒等，那么就不要选择带有该标识的机场），可玩性较低（第三方代理工具一般能折腾的地方较多，而私有客户端往往功能较单一），切换机场麻烦（对于有多家机场的人来说，想在多家机场的节点中来回切换，原先只需要在一个软件中操作，而这种情况则需要在多个软件中操作）。另外，这类机场由于强制使用客户端，因此，其无论使用的协议多新多罕见，我都不提供标注（做标注的目的是防止大家使用的代理工具不支持相应协议），入口信息也不提供（准确说是我几乎无法获取，这也正是其防通报与攻击的原因。不过通过抓包的方式应该还是可以获取，但是会麻烦很多）。总而言之，这种方式是一把双刃剑，如果无法接受其诸多缺点，那么请直接避开带有这类标识的机场。但即使能接受，**购买套餐前**，**建议先下载相应的客户端**，**并确保能成功登录**，**再购买**，防止因各种原因无法使用客户端而“白买”。另外，**如果发现所有节点都无法使用且长时间未恢复**，**那可能是当前版本的客户端因存在某些 BUG 而被“弃用”了**，**此时建议去机场官网下载新版本的客户端**（**客户端本身不一定支持更新功能**）。
 - ✋：**表示该机场默认无法获取订阅链接**，**需要手动发工单申请才能使用订阅链接**，**否则的话只能使用该机场的客户端**。这是一种通过人工审核的方式尽可能“清除内鬼”（正常用户一般申请后都能通过。内鬼一般指将订阅链接发布到各种公开平台上之类的人），以减少被通报与被攻击的情况，略显麻烦，不过好在只需要申请一次，申请通过之后就可以重新在官网看到“获取订阅”相关的按钮了。
 - 📜：**表示该机场存在一些我个人认为有必要附加说明的事项**。如兼容性问题，或是杂七杂八的东西。**具体会在机场列表下方中单独说明**。
 - 协议 1.0（此部分的标识已弃用，详见下方的 `协议 2.0`）：目前大部分机场所使用的协议有 `Shadowsocks`，`Trojan`，`VMess`，这三种**常用协议在主流的代理软件上都可得到支持**，所以，**使用了常用协议的机场我不作标识**。而 `Vless` 和 `Hysteria2` 这两种**新兴协议则只有少量的代理软件支持**。对于中转机场来说，目前最好用的协议依然是 `Shadowsocks`，几乎所有中转机场都是使用的此协议。至于直连机场，由于线路结构的原因，使用此协议会很快被墙，所以几乎所有直连机场都不使用此协议。`Shadowsocks` 协议之外的其他协议，都是直连机场常用的协议，包括 `Vless` 和 `Hysteria2`，这两个新协议被墙的几率从一定程度上也会低于 `Trojan` 和 `VMess`，所以现在这两种协议确实已逐渐成为直连机场的主流协议了，因为 GFW 对于新协议流量特征的掌握程度肯定少于另外两者，但这其实也只是从理论层面上分析，并非说明新协议 100% 优于旧协议。不过，就我个人体验而言，这两种协议在直连机场的表现的确比旧协议好。若需使用到这两种新协议，Windows，Mac 和 Linux 系统可使用 [Clash Verge](https://github.com/zzzgydi/clash-verge/releases/tag/v1.3.8)（版本不可低于此链接的版本，即 `v1.3.8`，否则将只能使用 `Vless`，而无法使用 `Hyteria2`。且要将内核切换为 `Meta` 内核。）（`2024.8.11` 补充：现在更推荐使用 [Clash Verge Rev](https://github.com/clash-verge-rev/clash-verge-rev)，[FlClash](https://github.com/chen08209/FlClash) 等其他软件，因为 `Clash Verge` 已经不再维护更新了），Android 系统可使用 [Clash Meta for Android](https://github.com/MetaCubeX/ClashMetaforAndroid/releases/tag/v2.9.0)（版本不可低于此链接的版本，即 `v2.9.0`， 否则将只能使用 `Vless`，而无法使用 `Hysteria2`），iOS 系统可使用 `Shadowrocket`（版本不可低于 `v2.2.35`，否则的话将只能使用 `Vless`，而无法使用 `Hysteria2`。若是低于 `v2.2.30`，则连 `Vless` 也不支持）。当然，还有其他代理软件也支持这两种协议，此处就不一一列举了，感兴趣的自行查阅资料（`Vless` 协议可能会搭配 `Reality` 协议使用。`Reality` 也是一种较新的协议，不过一般支持 `Vless` 协议的代理软件都会支持 `Reality` 协议，所以通常查清楚代理软件是否支持 `Vless` 就可以了）。针对这部分**使用了新兴协议的机场**，**我在机场官网后面加上了相关标识**。标识含义如下：
 ...
 - 协议 2.0：随着时间发展，市面上绝大部分代理软件都已支持 `Vless` 和 `Hysteria2` 协议，所以不再对这两个协议作标识（当初作标识是因为市面上陆续有机场使用了这两款协议， 但恰逢 `Clash for Windows` 删库，而它用户量极大，却不支持这两款协议。如今几年过去了，缓冲时间够长了，它的用户量已下降很多，所以我觉得没必要再浪费精力替这类软件“维护”了。若要购买本文的机场，默认至少应使用不低于上述 `协议 1.0` 所提及的软件版本，即能支持 `Vless` 和 `Hysteria2` 协议。虽然并不是每一家机场都使用了这两款协议，但是这两款协议早已得到广泛应用，如果还有软件不支持，那么我觉得是时候将这种软件丢进垃圾桶了。翻墙是需要不断学习的，想靠某个软件或者某个机场“养老”是不合理且不可能的）。此部分是对上述 `协议 1.0` 的拓展，即介绍比 `Vless` 和 `Hysteria2` 更为“新”的协议，那便是 `AnyTLS` 和 `xhttp`。这两者其实也发展好一段时间了，只不过一直得不到广泛使用。此前，市面上使用这两个协议的机场屈指可数，本文中的机场截至此部分内容诞生（2026.04.17）前，也只有少数机场的极少数节点使用过 `AnyTLS` 协议，所以我一直没给此协议添加相关标识，只作临时性通知。而近期由于“拔线事件”让不少中转机场身处困境，本文中的中转机场自然也是难逃此劫。其中有些便提供了直连节点作为备用，并且所使用的正是 `AnyTLS` 协议或 `xhttp`。虽然目前这两者依然没有被广泛使用，但是当前形势下，或许他们也会被慢慢普及（注：**新协议不代表一定更好**，**请根据自身网络环境考虑是否要选择有新协议的机场**）。若想使用 `AnyTLS` 协议，Windows，Mac，Linux 以及 Android 系统可使用 [FlClash](https://github.com/chen08209/FlClash/releases/tag/v0.8.77)（版本不可低于此链接的版本，即 `v0.8.77`）。iOS 系统可使用 `Shadowrocket`（版本不可低于 `v2.2.64`）。若想使用 `xhttp` 协议，`Windows`，`Mac` 以及 `Linux` 系统可使用 [V2rayN](https://github.com/2dust/v2rayN/releases/tag/7.16.6)（版本不可低于此链接的版本，即 `v7.16.6`），Android 系统可使用 [Clash Meta for Android](https://github.com/MetaCubeX/ClashMetaForAndroid/releases/tag/v2.11.25)（版本不可低于此链接的版本，即 `2.11.25`），iOS 系统可使用 `Shadowrocket`（版本不可低于 `v2.2.78`）。还有其他代理软件也支持这两款协议（友情提示：`Mihomo` 内核在 `v1.9.22` 的版本才支持 `xhttp` 协议。截至本内容的创作时间，基于该内核的 `Clash Party` 和 `FlClash` 的最新版本都不支持 `xhttp` 协议，若想在这两款软件使用该协议，感兴趣的可自行将他们的 `Mihomo` 内核更换为 `v1.19.22` 的版本。或者直接等待他们后续适配），就不都列举了，感兴趣的自行查阅资料，但要注意几个问题：① 支持 `AnyTLS` 不一定支持 `xhttp`，反过来同理。② 同一作者所开发的软件支持的协议不一定相同。比如 `V2rayN` 和 `V2rayNG` 的作者虽是同个人，前者支持 `AnyTLS` 协议，而后者不支持。因为后者只有 `Xray` 内核，该内核一直不支持 `AnyTLS` 协议，所以它就不支持。而前者则既有 `Xray` 内核，又有 `Sing-Box` 内核，因此支持的协议就更多。不过，`Xray` 内核本身支持的协议其实非常多，不适配 `AnyTLS` 是因为 `Xray` 内核的作者看不惯 `AnyTLS` 协议的作者，参见此 [issue](https://github.com/XTLS/Xray-core/issues/5089#issuecomment-3258885791)。因此，只使用 `Xray` 内核的 `V2rayNG` 未来可能会一直不支持 `AnyTLS`。③ 关于支持 `xhttp` 的代理软件，若低于上述所提及的版本，也可能会支持该协议，但是可能会存在较多 BUG。④ `xhttp` 协议往往会搭配 `Vless` 协议进行使用，而一些代理软件虽支持 `Vless` 却不支持 `xhttp`，那就可能出现一个状况：导入节点时没有任何报错，而使用了 `xhttp` 的节点全部超时。也就是说，导入时没报错，不代表该软件就一定支持相应节点。事实上，**主流代理软件通常是不会因为订阅中存在不支持的协议就报错的**，**要么是直接剔除相应节点**，**要么是能导入但超时**。针对这部分更为新的协议，我提供了如下标识：
    - `A`：表示该机场大部分节点都为常用协议，**极少部分**节点使用了 `AnyTLS` 协议。
    - `X`：表示该机场大部分节点都为常用协议，**极少部分**节点使用了 `xhttp` 协议。
    - `AX`：表示该机场大部分节点都为常用协议，**极少部分**节点使用了 `AnyTLS` 或 `xhttp` 协议。
    - `*A`：表示该机场**绝大部分或所有**节点都为 `AnyTLS` 协议。
    - `*X`：表示该机场**绝大部分或所有**节点都为 `xhttp` 协议。
    - `*AX`：表示该机场**绝大部分或所有**节点都为 `AnyTLS` 或 `xhttp` 协议。
    - 补充说明：此部分所说的“常用协议”跟 `协议 1.0` 里所说的“常用协议”是不同的。`Vless` 和 `Hysteria2` 在此处都已视为“常用协议”。
 - 类型：描述了机场的主要线路类型是直连还是中转（带 `+` 的直连是经过特殊优化的直连机场，价格与体验基本无异于中转机场，但是防失联能力也跟中转机场一样较弱，两者都有可能出现节点全部不可用的情况。而普通直连机场价格虽然最低，但是在防失联能力反而最强，极少出现节点全部不可用的情况）。
    - **在选购机场时**，**按自己预算选即可**，**没必要刻意追求专线**，因为专线的性价比太低。**确认自己需要的是直连（价格较低，流量充足，稳定性一般，防失联能力强。不一定适合用来当主力，但一定适合用来当备用）还是中转（价格中等，流量适中，稳定性较好，防失联能力弱）即可**。不过，直连机场有些时候反而会比中转机场“稳定”，比如国内入口被大面积通报时。事实上，自从 2025 年中旬开始的“通报事件”后，即使是中转机场，稳定性也已经大不如前了。此前，很多中转机场的节点是可以轻易做到连续一个月甚至几个月不掉线的，现在是几乎没有机场可以做到了，即使是业内最顶尖的专线机场。
 ...
 - 其他注意项：强烈建议在购买套餐前，仔细阅读机场的公告和套餐介绍（且定期“重温”，因为这些东西不是一成不变的），防止在使用机场过程中产生“意料之外”的状况。比如，有些机场会限制每日用量不能超过套餐总量的 10%（此项限制一般是为了防止有人长时间跑满宽带而导致大部分人的体验很差），又或者不允许使用订阅转换（此项限制一般是为了防止订阅泄露而导致机场易受攻击或是通报等），再或者是对自家客户端的一些使用说明等。
...
| 2020.04.22 | [次元雲](https://ciyy.one/#/register?code=tsL8Me6h)<br>`A` | 中转 | 1 | 17.00 / 158 GB | 99.00 / 520 GB | Null | 9 折<br>`ciyy-999`<br>季付套餐可用<br>8 折<br>`ciyy-80`<br>年付套餐可用<br>9 折<br>`9999`<br>不限时套餐可用<br>短期有效 |
...
| 2023.05.01 | 🟨<br>[农夫山泉](https://qqq.nfsqttt.com/#/register?code=HvoPMFli)<br>🔒 | 中转 | 1 | 15.00 / 200 GB | 45.00 / 200 GB | Null | Null |
...
| 2023.09.12 | [M78星云](https://m78star.cloud/#/register?code=7IWr2dOP)<br>`A`<br>🔒<br>📜 | 中转 | 1 |  12.80 / 150 GB | 99.00 / 300 GB | Null | 85 折<br>`season85`<br>季付套餐可用<br>82 折<br>`halfyear82`<br>半年付套餐可用<br>8 折<br>`year80`<br>年付套餐可用<br>5.10 前有效 |
...
- 壹速云：
     - 限制每日新注册人数，具体数量未知，如当日以达上限，点击上方链接进入官网后会有相关提示（不过，当前实际是完全停止新注册）。
- 鱼鱼：
     - 一家爱折腾协议的机场，适合同样爱折腾的用户。如果介意协议变来变去，或者不喜欢尝试新协议，请勿购买。
- 蜂窝云：
     - 虽然我为其添加了 🔒 标识，但其实依然能使用订阅链接（注：该订阅链接是阅后即焚的）。不过，订阅链接只包含直连节点，若想使用中转节点，必须使用其客户端。
     - 在导入订阅链接时，如果你所使用的代理工具是 `V2rayN` 或 `V2rayNG`，那么，需要导入两个链接才能获取所有直连节点，即官网的“复制 V2ray 订阅”和“复制 V2ray-VLESS 订阅”。电脑端的 `v2rayN` 自带合并多个订阅链接的功能，首先，在“url”旁边的输入框填上其中一个订阅链接，之后，点击输入框旁边的“三个点”（版本如果极其老旧则没有这个功能，建议更新至新版本），会弹出一个新的输入框，在这个新的输入框中填上另一个链接即可（若想合并三个及以上的链接，则用“英文的逗号”隔开这些链接）。当然，也可以分别导入两个链接，当成两个“分组”。而移动端的 `V2rayNG` 截至目前（2026.04.13）的最新版本（`v2.0.18`）仍不支持该功能，只能分别导入。
     - 可对订阅链接所获取的节点进行一点个性化设置，步骤为：官网 --> 节点列表 --> 订阅节点筛选。在该页面中可对节点进行简单的筛选，默认获取的是全部节点，入口为 `IPv4`。有两个注意点：① 如果你修改为“自定义获取节点”，那么建议定期进入该页面检查节点情况。因为，假如后来机场
- m78星云：
     - 虽然我为其添加了 🔒 标识，但其实依然能使用订阅链接。不过，订阅链接只包含直连节点，若想使用中转节点，必须使用其客户端。
...
🚪 下表是上述中转机场的国内入口信息（直连机场没有国内入口，所以表中不包含直连机场）。理论上，选择跟自己运营商相同以及地区相近的入口能够获得最优质的体验。但是实际上并非如此，“同地区同运营商”的体验不一定就比“不同地区不同运营商”差，而且机场入口会经常变动，尤其是在如今通报频繁的环境下，所以这个东西的参考意义其实也不是太大。不过个人建议还是尽可能选择入口有自己运营商的机场（受通报和拔线等影响，中转机场入口变化很频繁，此部分已于 2026.03.24 暂停更新）。

| 机场 | 入口运营商及地区 |
| :---: | :---: |
| 壹速云 | 联通：广东东莞<br> 移动：广东深圳 |
| 次元雲 | 电信：广东深圳<br> 移动：广东广州 |
| 兔兔云 | 移动：广东广州，湖南长沙 |
| Doriya | 移动：广东深圳，广东广州，广东江门 |
| FlyBit | 联通：广东深圳 <br>移动：广东广州 |
| NyanSS | 移动：广东广州 |
| ofoNet | 联通：广东深圳 |
...
| Mac | `Clash for Windows`，`ClashX`，`ClashX Pro`，`Clash Verge`，`Clash Verge Rev`，`Clash Nyanpasu`，`FlClash`，`V2rayN`，`sing-box`，`Stash`，`Surge`，`Quantumult X`，`Hiddify`，`Qv2ray`，`Streisand`，`Clash Party`，`Karing`，`Clash Mi`，`Sparkle`，`ClashMac`，`AnyPortal`，`Pandora Box`，`LanceX`，`vproxy` |
| Linux | `Clash for Windows`，`Clash Verge`，`Clash Verge Rev`，`Clash Nyanpasu`，`FlClash`，`V2ranN`，`Nekoray`，`sing-box`，`Hiddify`，`Qv2ray`，`Dae`，`Daed`，`Clash Party`，`GUI For SingBox`，`Sparkle`，`AnyPortal`，`Pantheon` |
...
💡 `iOS` 用户在使用机场过程中建议关闭 `iCloud 专用代理`，否则有可能导致节点无法使用。该功能是包含在 `iCloud+` 服务（付费功能）中的，未购买相关服务的用户可无视。
