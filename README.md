...
| 2020.04.22 | [次元雲](https://ciyy.one/#/register?code=tsL8Me6h)<br>`A` | 中转 | 1 | 17.00 / 256 GB | 99.00 / 520 GB | Null | 9 折<br>`ciyy-999`<br>季付套餐可用<br>8 折<br>`ciyy-80`<br>年付套餐可用<br>9 折<br>`9999`<br>不限时套餐可用<br>短期有效 |
...
- 壹速云：
     - 限制每日新注册人数，具体数量未知，如当日以达上限，点击上方链接进入官网后会有相关提示。
- Metcha：
     - 该机场会不定期重置所有人的订阅链接（原订阅链接失效，且通过原订阅链接导入的节点也会失效），需要重新前往官网导入订阅链接。如果你发现所有节点不可用，且订阅链接无法更新，那就可能是机场主重置了所有人的订阅链接。
- 鱼鱼：
...
🚪 下表是上述中转机场的国内入口信息（直连机场没有国内入口，所以表中不包含直连机场）。理论上，选择跟自己运营商相同以及地区相近的入口能够获得最优质的体验。但是实际上并非如此，“同地区同运营商”的体验不一定就比“不同地区不同运营商”差，而且机场入口会经常变动，尤其是在如今通报频繁的环境下，所以这个东西的参考意义其实也不是太大。不过个人建议还是尽可能选择入口有自己运营商的机场。

| 机场 | 入口运营商及地区 |
| :---: | :---: |
| 壹速云 | 联通：广东东莞<br> 移动：广东深圳 |
| 次元雲 | 电信：广东深圳<br> 移动：广东广州 |
| Metcha | 电信：广东东莞<br> 联通：广东东莞<br> 移动：广东深圳，广东揭阳 |
| 兔兔云 | 移动：广东广州，湖南长沙 |
